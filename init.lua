...
-- Git
vim.keymap.set('n', '<leader>bl', '<cmd>lua require"gitsigns".blame_line{full=true}<CR>', { desc = '[B]lame [L]ine' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>fa', '<cmd>Telescope find_files follow=true no_ignore=true hidden=true<CR>', { desc = '[F]ind [A]ll' })
      ...
      vim.keymap.set('n', '<leader>fw', builtin.live_grep, { desc = '[F]ind [W]words' })
